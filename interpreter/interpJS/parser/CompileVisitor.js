...
CompileVisitor.prototype.visitE_cons = function (ctx) {
    return new Expr.Cons(this.visit(ctx.expr(0)), this.visit(ctx.expr(1)));
};
...
CompileVisitor.prototype.visitE_application = function (ctx) {
    return new Expr.App(this.visit(ctx.expr(0)), this.visit(ctx.expr(1)));
};
...
CompileVisitor.prototype.visitE_let = function (ctx) {
    return new Expr.Let(ctx.variable().getText(), this.visit(ctx.expr(0)), this.visit(ctx.expr(1)));
};
...
CompileVisitor.prototype.visitE_tuple_proj = function (ctx) {
    return new Expr.Proj(this.visit(ctx.expr()), parseInt(ctx.INT().getText()));
};
...
CompileVisitor.prototype.visitAbstraction = function (ctx) {
    return new Expr.Abs(ctx.variable().getText(), this.visit(ctx.type()), this.visit(ctx.expr()));
};
...
CompileVisitor.prototype.visitT_arrow = function (ctx) {
    return new Type.ArrowType(this.visit(ctx.type(0)), this.visit(ctx.type(1)));
};
